    ...
    <section id="hero" className="min-h-screen relative flex items-center justify-center pt-24 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center z-10">
        ...
        <motion.h1
          ...
          className="font-outfit text-5xl md:text-7xl font-extrabold tracking-tight text-white mb-6 leading-none"
        >
        ...
        <motion.h2
          ...
          className="text-xl md:text-2xl font-semibold text-gray-300 mb-8 font-outfit"
        >
          {title}
        </motion.h2>
